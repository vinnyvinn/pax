                        ...
                        <form action="<?php echo e(route('city.update', $city->id)); ?>" method="post">
                            ...
                            <div class="form-group<?php echo e($errors->has('inbound_freight') ? ' has-error' : ''); ?>)">
                                ...
                                <select name="inbound_freight" id="inbound_freight" class="form-control" required>
                                    <?php $__currentLoopData = $accounts; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $account): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <option value="<?php echo e($account->AccountLink); ?>"<?php echo e($city->inbound_freight == $account->AccountLink ? ' selected' : ''); ?>><?php echo e($account->Account); ?> - <?php echo e($account->Description); ?></option>
                                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                </select>
                                <span>
                            ...
                            <div class="form-group<?php echo e($errors->has('domestic_freight') ? ' has-error' : ''); ?>)">
                                <label for="domestic_freight">Domestic Freight Account</label>
                                <select name="domestic_freight" id="domestic_freight" class="form-control" required>
                                    <?php $__currentLoopData = $accounts; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $account): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <option value="<?php echo e($account->AccountLink); ?>"<?php echo e($city->domestic_freight == $account->AccountLink ? ' selected' : ''); ?>><?php echo e($account->Account); ?> - <?php echo e($account->Description); ?></option>
                                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                </select>
                                <span>
                                    <?php if($errors->has('domestic_freight')): ?>
                                        <strong class="help-block"><?php echo e($errors->first('domestic_freight')); ?> </strong>
                                    <?php endif; ?>
                                </span>
                            </div>
