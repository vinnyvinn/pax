        ...
        <div class="row">
            <div class="col-md-12">
                <ol class="breadcrumb">
                  ...
                  <li><a href="<?php echo e(route('manifest.index', ['page' => 'clearance'])); ?>">Manifests</a></li>
            ...
            <div class="col-sm-12">
                <div class="panel panel-primary">
                            ...
                            <div role="tabpanel" class="tab-pane" id="bill_f_s">
                                ...
                                <div class="table-responsive">
                                    <table class="table table-striped nowrap">
                                        ...
                                        <tbody>
                                        <?php $__currentLoopData = $manifest->waybills->where('bill_to', 'S')->where('status', 'Undergoing Clearance'); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $waybill): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <tr>
                                                <?php if(Auth::user()->can('view-inbound-waybills')): ?>
                                                <td><strong><a href="<?php echo e(route('waybill.show', $waybill->id)); ?>"><?php echo e($waybill->waybill_number); ?></a></strong></td>
                                                <?php else: ?>
                            ...
                            <div role="tabpanel" class="tab-pane" id="bill_f_c">
                                ...
                                <div class="table-responsive">
                                    <table class="table table-striped nowrap">
                                        ...
                                        <tbody>
                                        <?php $__currentLoopData = $manifest->waybills->where('bill_to', 'C')->where('status', 'Undergoing Clearance'); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $waybill): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <tr>
                                                <?php if(Auth::user()->can('view-inbound-waybills')): ?>
                                                    <td><strong><a href="<?php echo e(route('waybill.show', $waybill->id)); ?>"><?php echo e($waybill->waybill_number); ?></a></strong></td>
                                                <?php else: ?>
                            ...
                            <div role="tabpanel" class="tab-pane" id="bill_f_o">
                                ...
                                <div class="table-responsive">
                                    <table class="table table-striped nowrap">
                                        ...
                                        <tbody>
                                        <?php $__currentLoopData = $manifest->waybills->where('bill_to', 'O')->where('status', 'Undergoing Clearance'); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $waybill): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <tr>
                                                <?php if(Auth::user()->can('view-inbound-waybills')): ?>
                                                    <td><strong><a href="<?php echo e(route('waybill.show', $waybill->id)); ?>"><?php echo e($waybill->waybill_number); ?></a></strong></td>
                                                <?php else: ?>
                    ...
                    <div class="panel-footer">
                        <a href="<?php echo e(route('manifest.index', ['page' => 'clearance'])); ?>" class="btn btn-danger">Back</a>
                    </div>
                </div>
            </div>
        </div>
