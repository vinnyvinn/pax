                    ...
                    <div class="panel-body">
                        ...
                        <form action="<?php echo e(route('manifest.store')); ?>" method="post" role="form" enctype="multipart/form-data">
                            ...
                            <div class="form-group<?php echo e($errors->has('cbv_number') ? ' has-error' : ''); ?>">
                                ...
                                <input type="text" class="form-control" name="cbv_number" id="cbv_number" value="<?php echo e(old('cbv_number')); ?>">
                            ...
                            <div class="form-group<?php echo e($errors->has('cbv_rate') ? ' has-error' : ''); ?>">
                                ...
                                <div class="input-group">
                                    ...
                                    <input pattern="[0-9\.]+$" aria-label="Rate per KG in decimal format" title="Rate per KG in decimal format" type="text" class="form-control" name="cbv_rate" id="cbv_rate" value="<?php echo e(old('cbv_rate')); ?>">
