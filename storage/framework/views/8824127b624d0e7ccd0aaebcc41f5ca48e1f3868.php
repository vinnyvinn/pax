                    ...
                    <div class="panel-body">
                        ...
                        <form action="<?php echo e(route('manifest.update', $manifest->id)); ?>" method="post" role="form">
                            ...
                            <div class="form-group<?php echo e($errors->has('cbv_rate') ? ' has-error' : ''); ?>">
                                ...
                                <input pattern="[0-9\.]+$" title="Rate per KG in decimal format" type="text" class="form-control" name="cbv_rate" id="cbv_rate" value="<?php echo e(isset($manifest->cbv_rate) ? $manifest->cbv_rate : old('cbv_rate')); ?>">
                            ...
                            <div class="form-group<?php echo e($errors->has('consignment_weight') ? ' has-error' : ''); ?>">
                                ...
                                <input pattern="[0-9\.]+$" title="Total consignment weight in decimal format" type="text" class="form-control" name="consignment_weight" id="consignment_weight" value="<?php echo e(isset($manifest->consignment_weight) ? $manifest->consignment_weight : old('consignment_weight')); ?>">
