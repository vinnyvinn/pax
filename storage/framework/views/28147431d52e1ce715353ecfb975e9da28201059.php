    ...
    <div class="row">
        <div class="col-lg-12">
            <div class="card card-outline-info">
                ...
                <form action="<?php echo e(route('customers.store')); ?>" class="form-bordered" method="POST">
                        ...
                        <div class="row">
                            <div class="form-group col-md-6">
                                <label class="control-label">Contact name</label>
                                    <input type="text" name="contact_name" placeholder="contact name" class="form-control" required>
                            ...
                            <div class="form-group col-md-4">
                                <label class="control-label">Contact Phone</label>
                                    <input type="number" name="contact_phone" placeholder="contact phone" class="form-control" required>
                            ...
                            <div class="form-group col-md-4">
                                <label class="control-label">Bill Account</label>
                                    <input type="text" name="bill_account" placeholder="bill account" class="form-control" required>
                            ...
                            <div class="form-group col-md-4">
                                <label class="control-label">Bill Company</label>
                                   <select class="form-control" name="bill_company" required>
                                      <option selected value="<?php echo e(\PAX\Models\Customer::BILL_FEDEX); ?>">FEDEX</option>
                                      <option value="<?php echo e(\PAX\Models\Customer::BILL_PAX); ?>">PAX</option>
                                    </select>
                                    <?php if($errors->has('bill_account')): ?>
