            ...
            <div class="col-lg-12">
                <div class="panel panel-default">
                    <div class="panel-heading">
                        Freight Invoices
                        <a href="<?php echo e(route('freight.create')); ?>" class="btn btn-primary btn-xs pull-right">
                    ...
                    <div class="panel-body">
                        <table class="table dataTable">
                            ...
                            <?php $__currentLoopData = $invoices; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $invoice): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <tr>
                                    <td><a target="_blank" href="<?php echo e(route('freight.show', $invoice->id)); ?>">INV<?php echo e($invoice->id); ?></a></td>
                                    ...
                                    <td>
                                        <?php if($invoice->type != PAX\Models\Invoice::ACTUAL_FREIGHT): ?>
                                            <a href="<?php echo e(route('freight.edit', $invoice->id)); ?>" class="btn btn-primary btn-xs"><i class="fa fa-pencil"></i></a>
                                            <button type="button" class="btn btn-danger btn-xs btn-destroy" data-token="<?php echo e(csrf_token()); ?>" data-url="<?php echo e(route('freight.destroy', $invoice->id)); ?>"><i class="fa fa-trash"></i></button>
                                        <?php endif; ?>
                                    </td>
                                </tr>
