                        ...
                        <table class="table dataTable">
                            ...
                            <?php $__currentLoopData = $manifests; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $manifest): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <tr>
                                    ...
                                    <td><?php echo e($manifest->arrival_time); ?></td>
                                    ...
                                    <td>
                                        <a href="<?php echo e(route('outbound.edit', $manifest->id)); ?>" class="btn btn-primary btn-xs"><i class="fa fa-pencil"></i></a>
                                        <button type="button" class="btn btn-danger btn-xs btn-destroy" data-token="<?php echo e(csrf_token()); ?>" data-url="<?php echo e(route('outbound.destroy', $manifest->id)); ?>"><i class="fa fa-trash"></i></button>
                                    </td>
                                </tr>
