                    ...
                    <div class="row">
                        ...
                        <div class="col-sm-6">
                            <div class="form-group">
                                ...
                                <input type="text" name="waybill_number" id="waybill_number" class="form-control" required value="<?php echo e(isset($domestic->waybill_number) ? $domestic->waybill_number : old('waybill_number')); ?>">
                            </div>
                            <div class="form-group">
                    ...
                    <div class="row">
                        ...
                        <div class="col-sm-6">
                            ...
                            <div class="form-group">
                                ...
                                <textarea name="shipment_description" rows="5" id="shipment_description" class="form-control"><?php echo e(isset($domestic->shipment_description) ? $domestic->shipment_description : old('shipment_description')); ?></textarea>
                            </div>
                        </div>
                        <div class="col-sm-6">
                            <div class="form-group">
                            ...
                            <div class="row">
                                <div class="col-sm-4">
                                    <input type="number" class="form-control" name="length" value="<?php echo e($domestic->length); ?>" placeholder="Length" required>
                                </div>
                                <div class="col-sm-4">
                                    <input type="number" class="form-control" name="width" value="<?php echo e($domestic->width); ?>" placeholder="width" required>
                                </div>
                                <div class="col-sm-4">
                                    <input type="number" class="form-control" name="height" value="<?php echo e($domestic->height); ?>" placeholder="height" required>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-sm-6">
                            ...
                            <select name="special_handling" id="special_handling" class="form-control">
                                <option value="None"<?php echo e($domestic->special_handling == 'None' ? ' selected' : ''); ?>>None</option>
                                <option value="HOLD at PAX Location"<?php echo e($domestic->special_handling == 'HOLD at PAX Location' ? ' selected' : ''); ?>>HOLD at PAX Location</option>
                                <option value="SATURDAY Delivery"<?php echo e($domestic->special_handling == 'SATURDAY Delivery' ? ' selected' : ''); ?>>SATURDAY Delivery</option>
                            </select>
                        </div>
                        ...
                        <div class="col-sm-6">
                            <div class="form-group">
                                ...
                                <input type="number" name="internal_billing_reference" id="internal_billing_reference" class="form-control"  value="<?php echo e(isset($domestic->internal_billing_reference) ? $domestic->internal_billing_reference : old('internal_billing_reference')); ?>">
                            </div>
                        </div>
                        ...
                        <div class="col-sm-6">
                            ...
                            <select name="bill_to" id="bill_to" class="form-control">
                                <option value="O"<?php echo e($domestic->bill_to == 'O' ? ' selected' : ''); ?>>Other</option>
                                <option value="S"<?php echo e($domestic->bill_to == 'S' ? ' selected' : ''); ?>>Shipper</option>
                                <option value="C"<?php echo e($domestic->bill_to == 'C' ? ' selected' : ''); ?>>Consignee</option>
                            </select>
                        </div>
                        ...
                        <div class="col-sm-6">
                            ...
                            <select name="bill_duty" id="bill_duty" class="form-control">
                                <option value="O"<?php echo e($domestic->bill_duty == 'O' ? ' selected' : ''); ?>>Other</option>
                                <option value="S"<?php echo e($domestic->bill_duty == 'S' ? ' selected' : ''); ?>>Shipper</option>
                                <option value="C"<?php echo e($domestic->bill_duty == 'C' ? ' selected' : ''); ?>>Consignee</option>
                            </select>
                        </div>
                    </div>
                    ...
                    <div class="row">
                        <div class="col-sm-12">
                            ...
                            <div class="form-group">
                                ...
                                <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('finalize-domestic-shipments')): ?>
