                ...
                <form action="<?php echo e(route('domestic.store')); ?>" method="post">
                    ...
                    <div class="col-sm-6">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" name="con_company" id="con_company" class="form-control" required value="<?php echo e(old('con_company')); ?>">
                        </div>
                        <div class="form-group">
                    ...
                    <div class="col-sm-6">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" name="con_address_alternate" id="con_address_alternate"
                                   class="form-control" required value="<?php echo e(old('con_address_alternate')); ?>">
                        </div>
                        <div class="form-group">
                            <label for="con_city">City</label>
                            <input type="text" name="con_city" id="con_city" class="form-control" required value="<?php echo e(old('con_city')); ?>">
                        </div>
                    </div>
                    <div class="col-sm-12">
                    ...
                    <div class="col-sm-6">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" name="shipment_description" id="shipment_description" class="form-control" value="<?php echo e(old('shipment_description')); ?>">
                        </div>
                    </div>
                    <div class="col-sm-6">
                        <div class="form-group">
                    ...
                    <div class="col-sm-12">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" name="packaging" id="packaging" class="form-control" value="<?php echo e(old('packaging')); ?>">
                        </div>
                    </div>
                    <div class="col-sm-10">
                        <div class="form-group">
