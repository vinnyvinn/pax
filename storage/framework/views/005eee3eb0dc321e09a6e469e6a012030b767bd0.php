                            ...
                            <div role="tabpanel" class="tab-pane" id="not_invoiced">
                                ...
                                <div class="table-responsive">
                                    <table class="table table-striped nowrap">
                                        ...
                                        <tbody>
                                        <?php $__currentLoopData = $manifest->waybills->where('freight_billed', false); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $waybill): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <tr>
                                                <td><strong><a href="<?php echo e(route('waybill.show', $waybill->id)); ?>"><?php echo e($waybill->waybill_number); ?></a></strong></td>
                                                <td><strong><?php echo e($waybill->crn_number); ?></strong></td>
                                                <td><strong><?php echo e(Carbon\Carbon::parse($waybill->shipped_date)->format('d F Y')); ?></strong></td>
                            ...
                            <div role="tabpanel" class="tab-pane" id="invoiced">
                                ...
                                <div class="table-responsive">
                                    <table class="table table-striped nowrap">
                                        ...
                                        <tbody>
                                        <?php $__currentLoopData = $manifest->waybills->where('freight_billed', true); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $waybill): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <tr>
                                                <td><strong><a href="<?php echo e(route('waybill.show', $waybill->id)); ?>"><?php echo e($waybill->waybill_number); ?></a></strong></td>
                                                <td><strong><?php echo e($waybill->crn_number); ?></strong></td>
                                                <td><strong><?php echo e(Carbon\Carbon::parse($waybill->shipped_date)->format('d F Y')); ?></strong></td>
