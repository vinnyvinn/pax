...
<div class="container">
    ...
    <div class="row">
        <div class="col-xs-4">
            <img src="<?php echo e(asset('images/fedex.png')); ?>" alt="FedEx" class="img-responsive" style="width: 130px !important;">
    ...
    <div class="row">
        <div class="col-xs-6">
            <h4><strong class="text-uppercase"><?php echo e($quote->con_name ?: $quote->con_company); ?></strong></h4>
            <h4><strong class="text-uppercase"><?php echo e($quote->con_phone ?: $quote->con_address); ?></strong></h4>
        </div>
        <div class="col-xs-4 col-xs-offset-2">
            <h5><strong class="text-uppercase">NUMBER: <span class="pull-right">QT<?php echo e(str_pad($quote->id, 5, '0', STR_PAD_LEFT)); ?></span></strong></h5>
    ...
    <div class="row">
        ...
        <div class="col-xs-9">
            <h4><?php echo e($quote->shipper_city); ?>, <?php echo e(getCountry($quote->shipper_country)); ?></h4>
            <h4><?php echo e($quote->con_city); ?>, <?php echo e(getCountry($quote->con_country)); ?></h4>
            <h4><?php echo e($quote->weight); ?></h4>
            <h4><?php echo e($quote->currency); ?></h4>
        </div>
    </div>
        ...
        <div class="col-xs-12">
            <table class="table plain-table table-striped table-bordered">
                ...
                <tr>
                    ...
                    <?php if($quote->category == PAX\Models\Quote::CATEGORY_INBOUND): ?>
                        <td class="text-right"><?php echo e(number_format($quote->subFuel + $quote->insurance + $quote->invoiceData->cck_levy, 2)); ?></td>
                    <?php else: ?>
                        <td class="text-right"><?php echo e(number_format($quote->subFuel + $quote->insurance, 2)); ?></td>
                    <?php endif; ?>
                    <td class="text-right"><?php echo e(number_format($quote->vat_amount, 2)); ?></td>
                    <td class="text-right"><?php echo e(number_format($quote->actualTotal, 2)); ?></td>
                </tr>
                </tbody>
            </table>
        </div>
    ...
    <div class="row">
        <div class="col-sm-12">
            ...
            <ol type="1">
                ...
                <li>The terms in this quotation are only valid for 14 days, i.e. <?php echo e(Carbon\Carbon::now()->addDays(7)->format('d/m/Y')); ?>.</li>
