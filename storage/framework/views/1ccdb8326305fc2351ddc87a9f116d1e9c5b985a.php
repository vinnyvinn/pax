                    ...
                    <div class="panel-body">
                        <form action="<?php echo e($data->id ? route('other-charges.update', $data->id) : route('other-charges.store')); ?>" method="post" role="form">
                            ...
                            <div class="form-group<?php echo e($errors->has('cost') ? ' has-error' : ''); ?>)">
                                ...
                                <input type="number" step="0.01" name="cost" id="cost" value="<?php echo e($data->id ? $data->cost : old('cost')); ?>" class="form-control" required>
                                <span>
                                    <?php if($errors->has('cost')): ?>
                                        <strong class="help-block"><?php echo e($errors->first('cost')); ?> </strong>
                                    <?php endif; ?>
                                </span>
                            </div>
