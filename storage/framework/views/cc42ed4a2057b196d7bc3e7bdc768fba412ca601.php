                                ...
                                <div role="tabpanel" class="tab-pane" id="waybills">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-sm-4">
                                            ...
                                            <input type="text" class="form-control" id="value" name="value" value="<?php echo e($waybill->value); ?>">
                                ...
                                <div role="tabpanel" class="tab-pane" id="dutiable-waybills">
                                    ...
                                    <div class="row">
                                        <div class="col-sm-4">
                                            ...
                                            <input type="text" readonly class="form-control" id="con_name" name="con_name" value="<?php echo e($waybill->con_name); ?>" required>

                                            <label for="con_company"><strong>Company (<?php echo e($waybill->con_company ?: '-'); ?>)</strong></label>
                                            <input type="text"  readonly class="form-control" id="con_company" name="con_company" value="<?php echo e($waybill->con_company); ?>" required>

                                            <label for="con_phone"><strong>Phone (<?php echo e($waybill->con_phone); ?>)</strong></label>
                                            <input type="text" readonly class="form-control" id="con_phone" name="con_phone" value="<?php echo e($waybill->con_phone); ?>" required>
                                        </div>

                                        <div class="col-sm-4">

                                            <label for="con_address"><strong>Address (<?php echo e($waybill->con_address ?: '-'); ?>)</strong></label>
                                            <input type="text" readonly class="form-control" id="con_address" name="con_address" value="<?php echo e($waybill->con_address); ?>" required>

                                            <label for="con_address_alternate"><strong>Alternate Address (<?php echo e($waybill->con_address_alternate ?: '-'); ?>)</strong></label>
                                            <input type="text" readonly class="form-control" id="con_address_alternate" name="con_address_alternate" value="<?php echo e($waybill->con_address_alternate); ?>">

                                            <label for="con_city"><strong>City (<?php echo e($waybill->con_company ?: '-'); ?>)</strong></label>
                                            <input type="text" readonly class="form-control" id="con_city" name="con_city" value="<?php echo e($waybill->con_city); ?>" required>

                                        </div>
                                        <div class="col-sm-4">

                                            <label for="con_state"><strong>State (<?php echo e($waybill->con_state ?: '-'); ?>)</strong></label>
                                            <input type="text" readonly class="form-control" id="con_state" name="con_state" value="<?php echo e($waybill->con_state); ?>">

                                            <label for="con_country"><strong>Country (<?php echo e($waybill->con_state ?: '-'); ?>)</strong></label>
                                            <input type="text" readonly class="form-control" id="con_country" name="con_country" value="<?php echo e($waybill->con_country); ?>">

                                            <label for="con_postal"><strong>Postal (<?php echo e($waybill->con_state ?: '-'); ?>)</strong></label>
                                            <input type="text" readonly class="form-control" id="con_postal" name="con_postal" value="<?php echo e($waybill->con_postal); ?>">
