            ...
            <div class="col-lg-8 col-lg-offset-2">
                <div class="panel panel-default">
                    ...
                    <div class="panel-body">
                        <form action="<?php echo e(route('route.update', $route->id)); ?>" method="post" role="form">
                            ...
                            <div class="form-group<?php echo e($errors->has('name') ? ' has-error' : ''); ?>)">
                                ...
                                <input type="text" name="name" id="name" value="<?php echo e(isset($route->name) ? $route->name : old('name')); ?>" class="form-control" required>
                                <span>
                            ...
                            <div class="form-group<?php echo e($errors->has('area_code_id') ? ' has-error' : ''); ?>)">
                                ...
                                <select name="area_code_id" id="area_code_id" class="form-control">
                                    <?php $__currentLoopData = $codes; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $code): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <option value="<?php echo e($code->id); ?>"<?php echo e($route->area_code_id == $code->id ? ' selected' : ''); ?>><?php echo e($code->name); ?></option>
