            ...
            <div class="col-sm-12">
                <div class="panel panel-primary">
                    ...
                    <div class="panel-body">
                        ...
                        <div class="tab-content">
                            ...
                            <div role="tabpanel" class="tab-pane" id="pod">
                                ...
                                <div class="row">
                                    <div class="col-sm-3">
                                        <h5><strong>Name</strong></h5>
                                        <p><?php echo e($waybill->pod_name); ?></p>
                                    </div>

                                    <div class="col-sm-3">

                                        <h5><strong>POD Date</strong></h5>
                                        <p><?php echo e($waybill->pod_date); ?></p>
                                    </div>
                                    <div class="col-sm-3">

                                        <h5><strong>POD Time</strong></h5>
                                        <p><?php echo e($waybill->pod_time); ?></p>
                                    </div>
                                    <div class="col-sm-3">

                                        <h5><strong>Courier</strong></h5>
                                        <p><?php echo e($waybill->courier ? $waybill->courier->name : '-'); ?></p>
                                    </div>
                                </div>
                        ...
                        <?php if($waybill->status == 'Awaiting Recovery'): ?>
                        <form action="<?php echo e(route('waybill.update', $waybill->id)); ?>" method="post">
                            ...
                            <div class="row">
                                <div class="form-group col-md-8 col-md-offset-2">
                                    ...
                                    <input required type="text" name="waiting_reason" value="<?php echo e($waybill->waiting_reason); ?>" id="waiting_reason" class="form-control">
