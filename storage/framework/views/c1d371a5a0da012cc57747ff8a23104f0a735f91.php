                    ...
                    <div class="panel-body">
                        <table class="table dataTable">
                            ...
                            <?php $__currentLoopData = $invoices; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $invoice): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <tr>
                                    <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('view-domestic-freight-invoice')): ?>
                                    ...
                                    <td>
                                        <?php if($invoice->type != PAX\Models\Invoice::ACTUAL_DOMESTIC): ?>
                                            <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('edit-domestic-freight-invoice')): ?>
                                                <a href="<?php echo e(route('domestic-freight.edit', $invoice->id)); ?>" class="btn btn-primary btn-xs"><i class="fa fa-pencil"></i></a>
                                            <?php endif; ?>

                                            <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('delete-domestic-freight-invoice')): ?>
