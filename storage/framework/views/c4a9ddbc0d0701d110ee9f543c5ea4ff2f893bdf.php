    ...
    <div class="container">
        ...
        <div class="row">
            <div class="col-md-8 col-md-offset-2">
                <div class="panel">
                <form action="<?php echo e(route('discount-rate-card.update', $data->id)); ?>" method="post" enctype="multipart/form-data">
                    ...
                    <div class="panel-body">
                        <div class="form-group">
                            ...
                            <select name="client_id" id="client_id" class="form-control">
                                ...
                                <option value="<?php echo e($client->DCLink); ?>" <?php echo e($client->DCLink == $data->client_id ? 'selected' : ''); ?>><?php echo e("{$client->Name} - {$client->Account}"); ?></option>   
