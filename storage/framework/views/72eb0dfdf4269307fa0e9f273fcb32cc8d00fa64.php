    ...
    <div class="container">
        <div class="row">
            <div class="col-md-12">
                <ol class="breadcrumb">
                  ...
                  <li><a href="<?php echo e(route('sales-rate-card.index')); ?>">Sales rates</a></li>
        ...
        <div class="row">
            <div class="col-md-8 col-md-offset-2">
                <div class="panel">
                <form action="<?php echo e(route('sales-rate-card.update', $data->id)); ?>" method="post" enctype="multipart/form-data">
