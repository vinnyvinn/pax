            ...
            <div class="col-md-12">
                <div class="panel">
                    <div class="panel-heading">
                        ...
                        <div class="col-md-6">
                            <a href="<?php echo e(route('sales-rate-card.create')); ?>" class="btn btn-sm btn-primary pull-right"><i class="fa fa-plus"></i> Rate card</a>
                        </div>
                    </div>
                           ...
                           <table class="table">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                        <a href="<?php echo e(route('sales-rate-card.edit', $rateCard->id)); ?>" class="btn btn-sm btn-info" title="Edit">
                                            <i class="fa fa-edit"></i></a>
                                            <a href="<?php echo e(route('sales-rate-card.show', $rateCard->id)); ?>" class="btn btn-sm btn-info" title="Show">
                                                <i class="fa fa-eye"></i></a>
                                            <button type="button" class="btn btn-danger btn-sm btn-destroy" data-token="<?php echo e(csrf_token()); ?>" data-url="<?php echo e(route('sales-rate-card.destroy', $rateCard->id)); ?>">
