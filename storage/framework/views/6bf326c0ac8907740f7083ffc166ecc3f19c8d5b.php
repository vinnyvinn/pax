                        ...
                        <form action="<?php echo e(route('manifest.store')); ?>" method="post" role="form" enctype="multipart/form-data">
                            ...
                            <div class="form-group<?php echo e($errors->has('manifest_type') ? ' has-error' : ''); ?>">
                                ...
                                <select class="form-control" name="manifest_type" id="manifest_type">
                                    <option value="<?php echo e(\PAX\Models\Manifest::MANIFEST_air); ?>">Air Freight</option>
                                    <option value="<?php echo e(\PAX\Models\Manifest::MANIFEST_sea); ?>">Sea Freight</option>
                                    <option value="<?php echo e(\PAX\Models\Manifest::MANIFEST_courier); ?>">Courier Freight</option>
                                </select>
