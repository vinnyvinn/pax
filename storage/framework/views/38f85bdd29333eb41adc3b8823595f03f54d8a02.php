    ...
    <div class="col-xs-12">
        ...
        <?php else: ?>
            ...
            <tr>
                <td>EXCISE DUTY</td>
                <td class="text-right">0.00</td>
                <td class="text-right"><?php echo e(number_format(($invoice->local_amount * ($invoice->excise_duty/100)), 2)); ?></td>
            </tr>
            <tr>
                <td>IDF</td>
                <td class="text-right">0.00</td>
                <td class="text-right"><?php echo e(number_format(($invoice->local_amount * ($invoice->idf/100)), 2)); ?></td>
            </tr>
            <tr>
                <td>VAT IMPORT</td>
                <td class="text-right">0.00</td>
            ...
            <tr>
                ...
                <td class="text-right">0.00</td>
                <td class="text-right"><?php echo e(number_format(($invoice->local_amount * ($invoice->rdl/100)), 2)); ?></td>
            </tr>
            <tr>
                <td>GOK</td>
                <td class="text-right">0.00</td>
                <td class="text-right"><?php echo e(number_format(($invoice->local_amount * ($invoice->gok/100)), 2)); ?></td>
            </tr>
            <tr>
                <td>KAA</td>
                <td class="text-right">0.00</td>
                <td class="text-right"><?php echo e(number_format(($invoice->local_amount * ($invoice->kaa/100)), 2)); ?></td>
            </tr>
            <tr>
                <td>KEBS FEE</td>
                <td class="text-right">0.00</td>
