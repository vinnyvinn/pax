                    ...
                    <div class="panel-body">
                        <table class="table dataTable">
                            ...
                            <?php $__currentLoopData = $invoices; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $invoice): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <tr>
                                    <td><a target="_blank" href="<?php echo e(route('outbound.freight.show', $invoice->id)); ?>">INV<?php echo e($invoice->id); ?></a></td>
                                    ...
                                    <td>
                                        <?php if($invoice->type != PAX\Models\Invoice::ACTUAL_FREIGHT): ?>
                                            <a href="<?php echo e(route('outbound.freight.edit', $invoice->id)); ?>" class="btn btn-primary btn-xs"><i class="fa fa-pencil"></i></a>
