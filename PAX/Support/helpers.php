...
function hasInbound()
{
    $permissions = [
        ...
        'Create Inbound Waybills', 'View Inbound Waybills', 'Delete Inbound Waybills',
    ...
    foreach ($permissions as $permission) {
        if (Auth::user()->can(str_slug($permission))) {
            return true;
        }
    }
...
function hasDomestic()
{
    $permissions = [
        ...
        'Create Domestic Waybills', 'View Domestic Waybills', 'Edit Domestic Waybills', 'Delete Domestic Waybills',
...
function hasShipments($type)
{
    $permissions = [
        'Create ' . $type . ' Shipments', 'View ' . $type . ' Shipments', 'Edit ' . $type . ' Shipments',
        'Delete ' . $type . ' Shipments', 'Create ' . $type . ' Waybills', 'View ' . $type . ' Waybills',
        'Delete ' . $type . ' Waybills',
    ];
...
function hasFreight($type)
{
    $permissions = [
        'Create ' . $type . ' Freight Invoice', 'View ' . $type . ' Freight Invoice',
        'Edit ' . $type . ' Freight Invoice', 'Delete ' . $type . ' Freight Invoice',
    ];
...
function hasClearance()
{
    $permissions = [
        ...
        'Delete Clearance Invoice', 'Finalize Clearance Invoice',
        'Create Agent Clearance Invoice', 'View Agent Clearance Invoice', 'Edit Agent Clearance Invoice',
        'Delete Agent Clearance Invoice', 'Finalize Agent Clearance Invoice', 'Generate Release Orders',
    ];
...
function pax_date_format($date = null, $format='Y-M-d') {
...
{
    return [
        'AFA', 'AWG', 'AUD', 'ARS', 'AZN', 'BSD', 'BDT', 'BBD', 'BYR', 'BOB', 'BRL', 'GBP', 'BGN', 'KHR', 'CAD',
        'KYD', 'CLP', 'CNY', 'COP', 'CRC', 'HRK', 'CPY', 'CZK', 'DKK', 'DOP', 'XCD', 'EGP', 'ERN', 'EEK', 'EUR',
        'GEL', 'GHC', 'GIP', 'GTQ', 'HNL', 'HKD', 'HUF', 'ISK', 'INR', 'IDR', 'ILS', 'JMD', 'JPY', 'KZT', 'KES',
        'KWD', 'LVL', 'LBP', 'LTL', 'MOP', 'MKD', 'MGA', 'MYR', 'MTL', 'BAM', 'MUR', 'MXN', 'MZM', 'NPR', 'ANG',
        'TWD', 'NZD', 'NIO', 'NGN', 'KPW', 'NOK', 'OMR', 'PKR', 'PYG', 'PEN', 'PHP', 'QAR', 'RON', 'RUB', 'SAR',
        'CSD', 'SCR', 'SGD', 'SKK', 'SIT', 'ZAR', 'KRW', 'LKR', 'SRD', 'SEK', 'CHF', 'TZS', 'THB', 'TTD', 'TRY',
