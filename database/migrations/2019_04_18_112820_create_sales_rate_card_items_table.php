...
class CreateSalesRateCardItemsTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('sales_rate_card_items', function (Blueprint $table) {
            $table->increments('id');
            $table->integer('sales_rate_card_id')->unsigned();
            ...
            $table->foreign('sales_rate_card_id')->references('id')->on('sales_rate_cards')->onDelete('cascade');
        });
    }
    ...
    {
        Schema::dropIfExists('sales_rate_card_items');
    }
}
