...
class CreateWaybillsTable extends Migration
{
    ...
    public function up()
    {
        Schema::create('dbo.waybills', function (Blueprint $table) {
            ...
            $table->string('category')->default(Waybill::CATEGORY_INBOUND);
            $table->integer('type')->default(Waybill::NON_DUTIABLE);
            ...
            $table->string('clearing_agent')->default(Waybill::CA_PAX);
            $table->string('clearing_agent_name')->default(Waybill::CA_PAX);
