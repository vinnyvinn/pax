                ...
                <div class="panel panel-default">
                    ...
                    <div class="panel-body">
                        ...
                        <form :action="'/invoice' + (isEdit ? '/' + id : '')" method="post" role="form">
                            ...
                            <input type="hidden" name="category" value="Non-Fedex Inbound">
                            <input type="hidden" name="route" value="non-invoices">
    ...
    export default {
        ...
        methods: {
            getEditDetails() {
                ...
                axios.get('/invoice/' + this.id +'/edit?fill-non=t').then((response) => {
            ...
            getDetails() {
                this.$root.isLoading = true;
                axios.get('/invoice/create?fill-non=t').then((response) => {
                    this.waybills = response.data.waybills;
                    this.clients = response.data.clients;
                    this.settings = response.data.settings;
                    this.tabulation.insurance_rate = this.settings['Current Insurance Rate']['current_value'];
