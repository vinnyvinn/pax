                            ...
                            <div class="row">
                                ...
                                <div class="col-sm-3">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <select name="con_country" id="con_country" class="form-control" v-model="freight.con_country">
                                            <option v-for="(code, country) in countries" :key="code" :value="code">{{ country }}</option>
                                        </select>
                                    </div>
                                ...
                                <div class="col-sm-3">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <h4 class="pull-right text-right">
                                            <strong>{{ parseFloat(freight.freight).toLocaleString('en-GB') }}</strong>
                                        </h4>
                                    </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <h5 class="pull-right text-right">
                                            <strong>{{ (parseFloat(freight.freight) + fuelLevy).toLocaleString('en-GB') }}</strong>
                                        </h5>
                                    </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <h5 class="pull-right text-right">
                                            <strong>{{ freight.cck_levy.toLocaleString('en-GB') }}</strong>
                                        </h5>
                                    </div>
    ...
    export default {
        ...
        methods: {
            getDetails() {
                ...
                axios.get('/quote/create?fill=t&type=1').then((response) => {
            ...
            getEditDetails() {
                this.$root.isLoading = true;
                axios.get('/quote/' + this.id + '/edit?fill=t&type=1').then((response) => {
                    this.countries = response.data.countries;
                    this.currencies = response.data.currencies;
