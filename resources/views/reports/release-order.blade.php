...
<div class="container">
    ...
    @foreach($waybills as $waybill)
        <h1 class="text-center">DELTAHANDLING</h1>
        ...
        <div class="row">
            <div class="col-xs-6">
                ...
                <h2><strong class="text-uppercase">{{ $waybill->con_name }}</strong></h2>
            </div>
            <div class="col-xs-6">
                <div class="text-right">
                    <h5><strong>KAHL CARGO CENTRE</strong></h5>
        ...
        <div class="row">
            <div class="col-xs-12 text-right">
                <h4><strong>Release Order Number: {{ $waybill->id }}</strong></h4>
            </div>
        </div>
            ...
            <div class="col-xs-12">
                <table class="table table-stripped table-bordered plain-table">
                    ...
                    <tr>
                        ...
                        <td>{{ $waybill->total }}</td>
                        <td>{{ number_format($waybill->actual_weight, 2) }} KGs</td>
                        <td>JKIA</td>
    ...
    @if(isset($manifest))
        <div class="row">
            <div class="col-xs-8">
                ...
                <h5>{{ $waybill->description }}</h5>
            </div>
            <div class="col-xs-4">
                <h5><strong>Value</strong></h5>
                <h5>{{ $waybill->currency }} {{ number_format($waybill->value, 0) }}</h5>

                <h5><strong>Arrive Date</strong></h5>
                <h5>{{ Carbon\Carbon::parse($manifest->flight_date)->format('d/m/Y') }}</h5>
            </div>
        </div>
    @else
        <div class="row">
            ...
            <div class="col-xs-4">
                ...
                <h5><strong>Arrive Date</strong></h5>
                <h5>{{ Carbon\Carbon::parse($waybill->shipped_date)->format('d/m/Y') }}</h5>
            </div>
        </div>
    @endif
