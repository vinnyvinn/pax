                            ...
                            <div role="tabpanel" class="tab-pane" id="bill_s">
                                ...
                                <div class="table-responsive">
                                    <table class="table table-striped nowrap">
                                        ...
                                        <tbody>
                                        @foreach($manifest->waybills->where('bill_duty', 'S') as $waybill)
                                            <tr>
                            ...
                            <div role="tabpanel" class="tab-pane" id="bill_c">
                                ...
                                <div class="table-responsive">
                                    <table class="table table-striped nowrap">
                                        ...
                                        <tbody>
                                        @foreach($manifest->waybills->where('bill_duty', 'C') as $waybill)
                                            <tr>
                                                @if(Auth::user()->can('view-inbound-waybills'))
                                                    <td><strong><a href="{{ route('waybill.show', $waybill->id) }}">{{ $waybill->waybill_number }}</a></strong></td>
                                                @else
                            ...
                            <div role="tabpanel" class="tab-pane" id="bill_o">
                                ...
                                <div class="table-responsive">
                                    <table class="table table-striped nowrap">
                                        ...
                                        <tbody>
                                        @foreach($manifest->waybills->where('bill_duty', 'O') as $waybill)
                                            <tr>
                                                @if(Auth::user()->can('view-inbound-waybills'))
                                                    <td><strong><a href="{{ route('waybill.show', $waybill->id) }}">{{ $waybill->waybill_number }}</a></strong></td>
                                                @else
                            ...
                            <div role="tabpanel" class="tab-pane" id="dutiable-waybills">
                                ...
                                <div class="table-responsive">
                                    <table class="table table-striped nowrap">
                                        ...
                                        <tbody>
                                        @foreach($manifest->waybills->where('type', PAX\Models\Waybill::DUTIABLE) as $waybill)
                                            <tr>
                                                @if(Auth::user()->can('view-inbound-waybills'))
                                                    <td><strong><a href="{{ route('waybill.show', $waybill->id) }}">{{ $waybill->waybill_number }}</a></strong></td>
                                                @else
                            ...
                            <div role="tabpanel" class="tab-pane" id="non-dutiable-waybills">
                                ...
                                <div class="table-responsive">
                                    <table class="table table-striped nowrap">
                                        ...
                                        <tbody>
                                        @foreach($manifest->waybills->where('type', PAX\Models\Waybill::NON_DUTIABLE) as $waybill)
                                            <tr>
                                                @if(Auth::user()->can('view-inbound-waybills'))
                                                    <td><strong><a href="{{ route('waybill.show', $waybill->id) }}">{{ $waybill->waybill_number }}</a></strong></td>
                                                @else
                            ...
                            <div role="tabpanel" class="tab-pane" id="van">
                                ...
                                <div class="table-responsive">
                                    <table class="table table-striped nowrap">
                                        ...
                                        <tbody>
                                        @foreach($manifest->waybills->where('status', 'Van Scan') as $waybill)
                                            <tr>
                                                @if(Auth::user()->can('view-inbound-waybills'))
                                                    <td><strong><a href="{{ route('waybill.show', $waybill->id) }}">{{ $waybill->waybill_number }}</a></strong></td>
                                                @else
                            ...
                            <div role="tabpanel" class="tab-pane" id="pod">
                                ...
                                <div class="table-responsive">
                                    <table class="table table-striped nowrap">
                                        ...
                                        <tbody>
                                        @foreach($manifest->waybills->where('status', 'POD') as $waybill)
                                            <tr>
                                                @if(Auth::user()->can('view-inbound-waybills'))
                                                    <td><strong><a href="{{ route('waybill.show', $waybill->id) }}">{{ $waybill->waybill_number }}</a></strong></td>
                                                @else
                            ...
                            <div role="tabpanel" class="tab-pane" id="dex">
                                ...
                                <div class="table-responsive">
                                    <table class="table table-striped nowrap">
                                        ...
                                        <tbody>
                                        @foreach($manifest->waybills->where('status', 'DEX') as $waybill)
                                            <tr>
                                                @if(Auth::user()->can('view-inbound-waybills'))
                                                    <td><strong><a href="{{ route('waybill.show', $waybill->id) }}">{{ $waybill->waybill_number }}</a></strong></td>
                                                @else
