...
/* harmony default export */ __webpack_exports__["default"] = ({
    ...
    components: { 'v-select': __WEBPACK_IMPORTED_MODULE_0_vue_select___default.a },
    ...
    methods: {
        getCustomers: function getCustomers() {
            ...
            this.loading = true;
            axios.get('/dispatch/customers/?view=allcustomers').then(function (response) {
                _this.loading = false;
...
module.exports={render:function (){var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;
  return _c('div', {
    ...
    class: _vm.loading ? 'fa fa-cog fa-spin' : 'fa fa-exchange'
  }), _vm._v(" Refresh \n         ")])])])
},staticRenderFns: []}
module.exports.render._withStripped = true
if (false) {
...
Component.options.__file = "C:\\Users\\ADMIN\\Desktop\\Projects\\pax\\pax\\resources\\assets\\js\\dismod\\components\\customer\\Form.vue"
...
Component.options.__file = "C:\\Users\\ADMIN\\Desktop\\Projects\\pax\\pax\\resources\\assets\\js\\dismod\\components\\customer\\Select.vue"
if (Component.esModule && Object.keys(Component.esModule).some(function (key) {return key !== "default" && key !== "__esModule"})) {console.error("named exports are not supported in *.vue files.")}
